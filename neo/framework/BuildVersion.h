...
const int BUILD_NUMBER_FULLY_POSSESSED = 1403; // Doom 3 BFG VR: Fully Possessed, not saved in file but generated based on gamename

const int BUILD_NUMBER = BUILD_NUMBER_FULLY_POSSESSED;

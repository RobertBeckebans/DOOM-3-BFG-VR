	...
	if( ::g->gamemode == commercial )
	{
		if( ::g->secretexit )
		{
			if( ::g->gamemission == doom2 )
			{
				switch( ::g->gamemap )
				{
					case  2: ::g->wminfo.next = 32;
						break; //Fix Doom 3 BFG Edition, MAP02 secret exit to MAP33 Betray
			...
			if( ::g->gamemission == doom2 )
			{
				switch( ::g->gamemap )
				{
					...
					case 32: ::g->wminfo.next = 15;
						break;
					case 33: ::g->wminfo.next =  2;
						break; //Fix Doom 3 BFG Edition, MAP33 Betray exit back to MAP03
